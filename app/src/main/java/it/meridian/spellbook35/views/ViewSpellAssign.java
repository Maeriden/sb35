...
public class ViewSpellAssign extends RelativeLayout
{
	...
	public ViewSpellAssign(Context context)
	{
		super(context);
	...
	{
		void onButtonClick(ViewSpellAssign view, int groupPosition, int childPosition);
	}
}
