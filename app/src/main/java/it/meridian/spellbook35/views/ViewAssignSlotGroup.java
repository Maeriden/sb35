...
public class ViewAssignSlotGroup extends RelativeLayout
{
	...
	public ViewAssignSlotGroup(Context context)
	{
		super(context);
	...
	public ViewAssignSlotGroup(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	...
	public ViewAssignSlotGroup(Context context, AttributeSet attrs, int defStyleAttr)
	{
	...
	{
		LayoutInflater.from(context).inflate(R.layout.view_assign_slot_group, this, true);
